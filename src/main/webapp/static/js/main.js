...
$(function() {
  ...
  AUDIO.global = {
    ...
    init: function() {
      AUDIO.global.deviceSize();
      AUDIO.global.layout();
      AUDIO.global.animsition();
    },
    ...
    layout: function() {
      var defaultHeaderScheme = 'scheme-default',
          ...
          defaultAppClasses = 'scheme-default default-scheme-color header-fixed aside-fixed rightbar-hidden appWrapper';
  ...
  AUDIO.navbar = {
    ...
    init: function() {
      AUDIO.navbar.menu();
      AUDIO.navbar.ripple();
      AUDIO.navbar.removeRipple();
      AUDIO.navbar.collapse();
      AUDIO.navbar.offcanvas();
    },
  ...
  AUDIO.extra = {
    ...
    init: function() {
      AUDIO.extra.sparklineChart();
      AUDIO.extra.slimScroll();
      AUDIO.extra.daterangePicker();
      AUDIO.extra.easypiechart();
      AUDIO.extra.chosen();
      AUDIO.extra.toggleClass();
      AUDIO.extra.colorpicker();
      AUDIO.extra.touchspin();
      AUDIO.extra.datepicker();
      AUDIO.extra.animateProgress();
      AUDIO.extra.counter();
      AUDIO.extra.popover();
      AUDIO.extra.tooltip();
      AUDIO.extra.splash();
      AUDIO.extra.lightbox();
    },
  ...
  AUDIO.isMobile = {
    ...
    any: function() {
      return (AUDIO.isMobile.Android() || AUDIO.isMobile.BlackBerry() || AUDIO.isMobile.iOS() || AUDIO.isMobile.Opera() || AUDIO.isMobile.Windows());
    }
  };
  ...
  AUDIO.documentOnResize = {

		init: function(){

      var t = setTimeout( function(){

        AUDIO.documentOnReady.setSidebar();
        AUDIO.navbar.removeRipple();
  ...
  AUDIO.documentOnReady = {

		init: function(){        
        AUDIO.global.init();
  			AUDIO.header.init();
        AUDIO.navbar.init();
        AUDIO.documentOnReady.windowscroll();
        AUDIO.tiles.init();
        AUDIO.extra.init();
        AUDIO.documentOnReady.setSidebar();
...
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  var $window = $(window),
    ...
    $(document).ready( AUDIO.documentOnReady.init );
    $window.load( AUDIO.documentOnLoad.init );
    $window.on( 'resize', AUDIO.documentOnResize.init );    

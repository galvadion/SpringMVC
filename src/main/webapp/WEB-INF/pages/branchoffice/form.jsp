	...
	<div class="page page-dashboard">
		...
		<div ng-if="vm.location[2] == 'create'" class="pageheader">
			<h1 class="custom-font" style="margin-top: -10px !important;">
				<strong>Sucursales </strong> Crear
			</h1>
			<ol class="breadcrumb">
		...
		<div ng-if="vm.location[2] == 'edit'" class="pageheader">
			<h1 class="custom-font" style="margin-top: -10px !important;">
				<strong>Sucursales </strong> Editar
			</h1>
			<ol class="breadcrumb">
				<li><a href="#/home">Dashboard</a></li>
				<li><a href="#/branchoffice">Sucursales</a></li>
						...
						<form form-on-change="checkFields()" name='form' class=""
							...
							<div class="form-group"
								...
								<label for="name" class="control-label">* Nombre</label> <input
									...
									id="name" ng-model="vm.branchoffice.name" placeholder="Nombre"
									required> <span
							...
							<div class="row">
								<div class="form-group col-sm-6" class="form-group"
									ng-class="{ 'has-error': form.city.$dirty && form.city.$error.required }">
									<label for="city" class="control-label">* Ciudad</label> <input
										type="text" name="city" id="city" class="form-control"
										ng-model="vm.branchoffice.city" placeholder="Ciudad" required>
									<span ng-show="form.city.$dirty && form.city.$error.required"
										class="help-block">Ciudad es requerida</span>
								</div>
								...
								<div class="form-group col-sm-6" class="form-group"
									...
									<input type="text" name="address" id="address"
										class="form-control" ng-model="vm.branchoffice.address"
										placeholder="Dirección" required> <span
										ng-show="form.address.$dirty && form.address.$error.required"
										class="help-block">Dirección es requerida</span>
								</div>
							</div>
							...
							<div class="row">
								<div class="form-group col-sm-6" class="form-group"
									...
									<label for="apertureHour" class="control-label">* Hora
										...
										required> <span
										ng-show="form.apertureHour.$dirty && form.apertureHour.$error.required"
										class="help-block">Apertura es requerido</span>
								</div>

								<div class="form-group col-sm-6" class="form-group"
									ng-class="{ 'has-error': form.closingHour.$dirty && form.closingHour.$error.required }">
									<label for="closingHour" class="control-label">* Hora
										de cierre</label> <input type="text" name="closingHour"
										id="closingHour" class="form-control"
										ng-model="vm.branchoffice.closingHour" placeholder="hh:mm"
										required> <span
										ng-show="form.closingHour.$dirty && form.closingHour.$error.required"
										class="help-block">Cierre es requerido</span>
								</div>
							</div>
							...
							<div class="row">
								<div class="form-group col-sm-12" class="form-group"
									...
									<ui-gmap-google-map center="map.center" zoom="map.zoom"
										draggable="true" options="options" events="map.events" name="location"
										id="location"> 
										<ui-gmap-marker ng-repeat="m in map.markers" coords="m.coords" icon="m.icon" idkey="m.id"></ui-gmap-marker>
										</ui-gmap-google-map>
									 <span
										ng-show="!vm.branchoffice.location" class="help-block">Localización
										es requerida</span>
								</div>
							</div>
					</div>

        	...
        	<div class="col-md-12">
            	...
            	<section class="tile">
                    ...
                    <div class="tile-header dvd dvd-btm">
                        <h1 class="custom-font"><strong>Nuestros </strong> servicios</h1>
                    </div>
                    <!-- /tile header -->

                    <!-- tile body -->
                    <div class="tile-body table-custom">
            			<p>Tengo que ser siempre el mejor, mejor que nadie más, 
            		...
            		<h1 class="logo" style="text-align: right !important; margin-right: 2px !important;">wow <img src="static/images/favicon.png"></h1>

...
<section id="content">
    ...
    <div class="page page-dashboard">
        ...
        <div class="pageheader">
        	<h1 class="custom-font" style="margin-top: -10px !important;"><strong>Actividades</strong></h1>
            <ol class="breadcrumb">
        ...
        <div class="row">
        	<div class="col-md-6">
            	<section class="tile">
					...
					<div class="tile-header dvd dvd-btm" id="searchResult">
                        <h1 class="custom-font"><strong>Retiran hoy </strong></h1>
                    </div>
        	...
        	<div class="col-md-6">
            	<section class="tile">
					...
					<div class="tile-header dvd dvd-btm" id="searchResult">
                        <h1 class="custom-font"><strong>Devuelven hoy </strong></h1>
                    </div>
